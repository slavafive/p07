...
import com.itmo.microservices.demo.order.api.messaging.OrderUpdatedEvent
...
class OrderServiceImpl(private val orderRepository: OrderRepository,
   ...
   override fun createOrder(): OrderDto {
    ...
    override fun addItemToOrder(orderId: UUID, itemId: UUID, amount: Int) {
        ...
        orderRepository.save(order)
        eventBus.post(OrderUpdatedEvent(order.toModel()))
        eventLogger.info(
            OrderServiceNotableEvents.I_ORDER_UPDATED,
            order
        )
    }
